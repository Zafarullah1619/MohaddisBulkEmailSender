...
namespace ASE
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/popup/js").Include(
            ...
            bundles.Add(new StyleBundle("~/bundles/font-awesome/css")
                ...
                .Include("~/Vendor/fontawesome/css/all.min.css", new CssRewriteUrlTransform()));
            ...
            bundles.Add(new ScriptBundle("~/bundles/moment/js").Include(
                      ...
                      "~/Vendor/moment/min/moment-timezone-with-data.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/datatables/js").Include(
                      "~/Vendor/datatables/media/js/jquery.dataTables.min.js", "~/Vendor/datatables/media/js/dataTables.buttons.js", "~/Vendor/datatables/media/js/buttons.html5.js", "~/Vendor/datatables/media/js/buttons.print.min.js", "~/Vendor/datatables/media/js/jszip.min.js", "~/Vendor/datatables/media/js/dataTables.responsive.min.js"));
            //"~/Vendor/datatables/media/js/jszip.min.js"
            ...
            bundles.Add(new StyleBundle("~/bundles/datatables/css").Include(
                      "~/Vendor/datatables_plugins/integration/bootstrap/3/dataTables.bootstrap.css", "~/Vendor/datatables/media/css/buttons.bootstrap.min.css", "~/Vendor/datatables/media/css/responsive.dataTables.min.css"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/datepicker/js").Include(
                      ...
                      "~/Content/datatimepicker/bootstrap-datetimepicker.min.js"
                      ));
            ...
            bundles.Add(new StyleBundle("~/bundles/datepicker/css").Include(
                      ...
                      "~/Content/datatimepicker/bootstrap-datetimepicker.min.css"
                      ));
            ...
            bundles.Add(new ScriptBundle("~/bundles/tagsinput/js").Include(
                      "~/Vendor/bootstrap/dist/js/bootstrap-tagsinput.min.js"));

            // Tags style
            bundles.Add(new StyleBundle("~/bundles/tagsinput/css").Include(
                      "~/Vendor/bootstrap/dist/css/bootstrap-tagsinput.css"));

            // Calender of Availability
            bundles.Add(new ScriptBundle("~/bundles/Calender/js").Include(
                      "~/Vendor/Calendar/js/Calendar.js"));

            // Calender of Availability
            bundles.Add(new StyleBundle("~/bundles/Calender/css").Include(
