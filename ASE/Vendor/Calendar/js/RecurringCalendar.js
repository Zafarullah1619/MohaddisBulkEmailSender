function RecurringInitializeAvailability(CalendarSelector, Q) {
    RecurringInitializeQuarterCalendar(CalendarSelector, 4, null, Q);
}

function RecurringInitializeAvailabilityCalendar(CalendarSelector, SelectedList, Q) {
    RecurringInitializeQuarterCalendar(CalendarSelector, 4, SelectedList, Q);
}
function RecurringInitializeQuarterCalendar(CalendarSelector, Quarters, SelectedList, Q) {
    ...
    //console.log("Hello Recurr " + SelectedList);
    //console.log(SelectedList[0][0].Duration);
    //console.log(Q);
...
function RecurringfindTimes(listObjects, key, StartTimeHour, StartTimeMinute, EndTimeHour, EndTimeMinute) {
...
function RecurringGetDayTimes(CalendarSelector, DayOfWeek) {
    var Times = [];
    var Count = 0;
...
function RecurringGetSelectedTimes(CalendarSelector) {
    var AllTimes = [];
    var Count = 0;
