...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "There is currently no data in the system")
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default There is currently no data in the system
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "There is currently no data in the system"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "There is currently no data in the system",
